(function ($) {
    ...
    $('[data-countdown]').each(function () {
		...
		$this.countdown(finalDate, function (event) {
			$this.html(event.strftime('<div class="single-countdown"><span class="single-countdown-time">%D :</span><span class="single-countdown-text"></span></div><div class="single-countdown"><span class="single-countdown-time">%H :</span><span class="single-countdown-text"></span></div><div class="single-countdown"><span class="single-countdown-time">%M :</span><span class="single-countdown-text"></span></div><div class="single-countdown"><span class="single-countdown-time">%S</span><span class="single-countdown-text"></span></div>'));
		});
	});
