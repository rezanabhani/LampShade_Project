...
namespace _01_LampshadeQuery.Query
{
    public class ProductQuery : IProductQuery
    {
        ...
        public ProductQueryModel GetDetails(string slug)
        {
            ...
            var productColor = _inventoryContext.ProductColors.Select(x => new { x.ProductId , x.Color }).ToList();
            ...
            //var productColorInventory = productColor.FirstOrDefault(x => x.ProductId == product.Id).Color.ToList();
            //product.ProductColors = productColorInventory.Color;
